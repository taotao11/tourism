    ...
    <div class="layui-col-md8 content detail">
      <div class="fly-panel detail-box">
        ...
        <div class="fly-detail-info">
          ...
          <span class="layui-badge layui-bg-green fly-detail-column">活动</span>
        ...
        <div class="detail-body photos">
          ...
          <p>推荐理由：</p>
<pre>
  # 活动时长:  ${activity.dataLen} 天
  # 活动人数:  ${activity.pLen} 人
${activity.reason}
</pre>

          封面<hr>
          <p>
            <img src="${pageContext.request.contextPath}/${activity.url}" alt="">
          </p>
        </div>
      </div>
      ...
      <div class="fly-panel detail-box" id="flyReply">
              ...
              <span class="jieda-zan zanok" type="zan">
                ...
                <c:if test="${admin != null}">
                  <div class="jieda-admin">
                    <a href="${pageContext.request.contextPath}/comment/delete?id=${cc.comment.id}&&type=2" type="del">删除</a>
                  </div>
                </c:if>
              </div>
            </li>
        ...
        <div class="layui-form layui-form-pane">
            ...
            <input type="hidden" id="jid"name="aid" value="${activity.id}">
