        ...
        <div style="text-align: center">
          <div class="laypage-main">
            <c:if test="${page.current != 1}">
              <a href="${pageContext.request.contextPath}/tList?current=${ page.current - 1 }&&type=0" class="laypage-last" title="尾页">上一页</a>
            </c:if>

            <span class="laypage-curr">${page.current}</span>

            <c:if test="${page.current < page.pages}">
              <a href="${pageContext.request.contextPath}/tList?current=${ page.current + 1 }&&type=0" class="laypage-last" title="尾页">下一页</a>
            </c:if>
        </div>
