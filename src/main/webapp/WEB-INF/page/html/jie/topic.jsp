    ...
    <div class="layui-col-md8 content detail">
      <div class="fly-panel detail-box">
        ...
        <div class="fly-detail-info">
          ...
          <span class="layui-badge layui-bg-green fly-detail-column">话题</span>
...
${topic.reason}
      ...
      <div class="fly-panel detail-box" id="flyReply">
              ...
              <span class="jieda-zan zanok" type="zan">
                ...
                <c:if test="${admin != null}">
                  <div class="jieda-admin">
                    <a href="${pageContext.request.contextPath}/comment/delete?id=${cc.comment.id}&&type=3" type="del">删除</a>
                  </div>
                </c:if>
              </div>
            </li>
        ...
        <div class="layui-form layui-form-pane">
            ...
            <input type="hidden" id="jid"name="jid" value="${topic.id}">
